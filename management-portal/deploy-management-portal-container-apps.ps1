...
az containerapp create `
	...
	--secrets "appinsights-connection-string=$appInsightsConnectionString" "cosmos-connection-string=$cosmosConnectionString" "azure-ad-client-id=e691193e-4e25-4a72-9185-1ce411aa2fd8" "azure-ad-tenant-id=16b3c013-d300-468d-ac64-7eda0820b6d3" `
