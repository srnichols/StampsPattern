...
| [🏗️ Security Architecture](#️-security-architecture) | Network micro-segmentation | Architects |
...
| [🛠️ Security Operations](#️-security-operations) | IR, automation, checklists | Security Ops |
