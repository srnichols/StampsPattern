    ...
    switch ($TenancyModel) {
        ...
        "mixed" {
            $regions += @{
                geoName = "northamerica"
                regionName = $Location
                cells = @("shared-smb", "shared-startup", "dedicated-enterprise")
                baseDomain = "$Location.stamps.contoso.com"
